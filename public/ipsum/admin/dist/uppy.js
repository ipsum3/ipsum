...
/* harmony import */ var _uppy_drag_drop__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_uppy_drag_drop__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _uppy_progress_bar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @uppy/progress-bar */ "./node_modules/@uppy/progress-bar/lib/index.js");
/* harmony import */ var _uppy_progress_bar__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_uppy_progress_bar__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _uppy_locales_lib_fr_FR__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @uppy/locales/lib/fr_FR */ "./node_modules/@uppy/locales/lib/fr_FR.js");
/* harmony import */ var _uppy_locales_lib_fr_FR__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_uppy_locales_lib_fr_FR__WEBPACK_IMPORTED_MODULE_4__);
...
window.uppyInit = function (upload) {
  ...
  renderMedia();
  var uppy = new _uppy_core__WEBPACK_IMPORTED_MODULE_0___default.a({
    debug: false,
    autoProceed: true,
    locale: _uppy_locales_lib_fr_FR__WEBPACK_IMPORTED_MODULE_4___default.a,
    restrictions: {
  ...
  uppy.use(_uppy_xhr_upload__WEBPACK_IMPORTED_MODULE_1___default.a, {
  ...
  uppy.use(_uppy_drag_drop__WEBPACK_IMPORTED_MODULE_2___default.a, {
    target: upload.querySelector('.upload-DragDrop'),
    note: upload.dataset.uploadnote
  });
  uppy.use(_uppy_progress_bar__WEBPACK_IMPORTED_MODULE_3___default.a, {
    target: upload.querySelector('.upload-ProgressBar'),
    hideAfterFinish: false
  });
  uppy.on('upload-success', function (file, response) {
    upload.querySelector('.upload-alerts').insertAdjacentHTML('beforeend', "<div class=\"alert alert-success\">".concat(response.body.message, "</div>"));
    renderMedia();
  });
  uppy.on('upload-error', function (file, error, response) {
    ...
    if (response.body.errors !== undefined && Array.isArray(response.body.errors.media)) {
      response.body.errors.media.forEach(function (error) {
        upload.querySelector('.upload-alerts').insertAdjacentHTML('beforeend', "<div class=\"alert alert-warning\">".concat(file.name, " : ").concat(error, "</div>"));
      });
    } else if (response.body.message !== undefined && response.body.message !== '') {
      upload.querySelector('.upload-alerts').insertAdjacentHTML('beforeend', "<div class=\"alert alert-warning\">".concat(file.name, " : ").concat(response.body.message, "</div>"));
    } else {
      upload.querySelector('.upload-alerts').insertAdjacentHTML('beforeend', "<div class=\"alert alert-warning\">".concat(file.name, " : ").concat(error, "</div>"));
    }
  });
...
/***/ 2:
/*!***************************************************!*\
  !*** multi ./src/scss/uppy.scss ./src/js/uppy.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./src/scss/uppy.scss */"./src/scss/uppy.scss");
module.exports = __webpack_require__(/*! ./src/js/uppy.js */"./src/js/uppy.js");
